# 99 bottles of beer with english number
...
puts "How many bottles of beers do you have?"
nb_btls = gets.chomp.to_i
exp_english_number(nb_btls)

while nb_btls > 2
puts "#{exp_english_number(nb_btls).capitalize} bottles of beer on the wall, #{exp_english_number(nb_btls)} bottles of beer."
puts "Take one down and pass it around, #{exp_english_number(nb_btls -= 1)} bottles of beer on the wall."
end
